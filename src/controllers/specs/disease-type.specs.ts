...
class DiseaseTypeCRUDSpecs implements CRUDSpecScheme {
  ...
  /**
   * Specifications to response total of pisease types.
   */
  ...
  /**
   * Specifications to response one pisease type.
   */
  ...
  /**
   * Specifications to response array of pisease types.
   */
  ...
  /**
   * Specifications to response count of pisease types updates.
   */
